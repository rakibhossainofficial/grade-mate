        ...
        <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
          <div className="flex flex-col items-center mx-12 lg:mx-0">
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                As an instructor, grading used to take a lot of time. With Grade Mate’s marking system, it’s much easier to review submissions and give students instant feedback. Highly recommended!
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
          ...
          <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
               Grade Mate has completely changed the way I manage assignments! Submitting and tracking marks is now super smooth. I love how quickly I can see feedback from instructors.
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
